                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our agency consistently receives top ratings for exceptional customer satisfaction and service.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We provide a seamless and personalized real estate experience, ensuring the highest quality at every step.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our seasoned agents offer expert guidance and valuable insights, making your real estate journey smooth and successful.</p>
									</div>
                                </li>
                            </ul>
                        </div>
